...
export const metadata: Metadata = {
  title: "PrepForce AI | AI-powered interview training platform",
  description: "Upload your resume and prepare for your next big role with PrepForce AI mock interviews.",
};
